            ...
            if data['code'] == 0 and data['message'] == '操作成功':
                ...
                for i in range(0, len(data['data'])):
                    ...
                    obj = {'shop_id': self.inst_.config_obj['shop_id'],
                           ...
                           'visitors': data['data'][i]['uv']['value'],
                           'add_to_cart_count': data['data'][i]['cartByrCnt']['value'],
                           'paid_buyers': data['data'][i]['payByrCnt']['value'],
                           'paid_amount': data['data'][i]['payByrCnt']['value']
                    }
